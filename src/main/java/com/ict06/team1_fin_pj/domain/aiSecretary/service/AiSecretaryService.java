 ...
 * @Description : AI 비서/챗봇 세션 및 메시지 관리 서비스 인터페이스
 * @Author : 송혜진
 * @Date : 2026. 04. 28
 ...
 * @ 수정일         수정자        수정내용
 * @ ----------    ---------    ----------------------------------------
 * @ 2026.04.28    송혜진        최초 생성 (AI 채팅 세션 및 메시지 저장 메서드 정의)
 * @ 2026.05.05    송혜진        CHATBOT 최근 48시간 내 단일 세션 조회 또는 생성 기준 추가
 * @ 2026.05.12    송혜진        ASSISTANT 최근 작성 목록 및 세션 메시지 조회 흐름 정리
 * @ 2026.05.22    송혜진        챗봇 RAG 검색 흐름과 세션 소유자 기준 empNo 연동 기준 반영
 */
